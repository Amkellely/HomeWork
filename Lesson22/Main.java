...
public class Main {
    ...
    public static boolean isDigth(String str, int i){
    ...
    public static boolean isLow(String str, int i){
    ...
    System.out.println((int)c);*/
        ...
        //Дана строка из строчных(маленьких) букв. Перевести в просписные (большие)
       /* String str = in.nextLine();
        ...
        //Вводится предложение на английском языке, без знаков припинания.
