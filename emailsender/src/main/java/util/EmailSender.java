...
public class EmailSender {
    ...
    private static final String PASSWORD = "ajvk sjgh ktif dyhi";
    ...
    public static void main(String[] args) {
        ...
        HTMLTableBuilder tableBuilder = new HTMLTableBuilder("HTML Table", true, 3, 3, 10, 10,10 );
        tableBuilder.addTableHeader("Company","Contact", "Country");
        tableBuilder.addRowValues("AlFriends", "Maria Andres","Germany");
        tableBuilder.addRowValues("Centro Fin", "Maria Andressov","France");

        send(FROM, subj, msg, tableBuilder(), "C:\\Users\\st\\IdeaProjects\\emailsender\\pom.xml");
